...
! NOTE (DariusM#1#): Uncommented above line
       & g_value_get_char, g_value_set_char, &
...
! NOTE (DariusM#1#): Changed for GLIB<2.32
          call g_value_set_char(val, int(ichar(svalue(1:1)), c_int8_t))
       else if (present(i8value)) then
!!$GLIB< 2.32!          call g_value_set_char(val, i8value)
!          call g_value_set_schar(val, i8value)

! NOTE (DariusM#1#): Changed for GLIB<2.32
          call g_value_set_char(val, i8value)
...
! NOTE (DariusM#1#): Changed for GLIB<2.32
          call g_value_set_char(val, int(ivalue, c_int8_t))
...
! NOTE (DariusM#1#): Changed for GLIB<2.32
          call g_value_set_char(val, int(lvalue, c_int8_t))
...
! NOTE (DariusM#1#): Changed for GLIB<2.32
          call g_value_set_char(val, int(l64value, c_int8_t))
       else
